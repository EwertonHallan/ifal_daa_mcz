...
require_once('../../classe/professor.php');
	...
	if (count($resultado)) {
	    ...
	    foreach ($resultado as $res) {
	        ...
	        $msg .=' <td align="center"><input type=button id=bt_sel'.$res['id_professor'].' name=bt_sel'.$res['id_professor'].' value="Selecionar" onclick="selCampo(cadJustificativa.id_professor,cadJustificativa.desc_id_professor,\''.$res['id_professor'].'\',\''.$res['nome'].'\');" /></td>';
	        $msg .='</tr>';
