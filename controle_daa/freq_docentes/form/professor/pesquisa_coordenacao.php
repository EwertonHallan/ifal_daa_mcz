...
require_once('../../classe/coordenacao.php');
	...
	if (count($resultado)) {
	    ...
	    foreach ($resultado as $res) {
	        ...
	        $msg .=' <td align="center"><input type=button id=bt_sel'.$res['id_coordenacao'].' name=bt_sel'.$res['id_coordenacao'].' value="Selecionar" onclick="selCampo(cadProfessor.id_coordenacao,cadProfessor.desc_id_coordenacao,\''.$res['id_coordenacao'].'\',\''.$res['nome'].'\');" /></td>';
	        $msg .='</tr>';
