...
if (!$erro) {
    ...
    $relatorio->nome_relatorio = 'REL_FECHAMENTOS';
    $relatorio->titulo_relatorio = 'CONTROLE DE APONTAMENTO';
    $relatorio->filtro_relatorio = NULL;
    
    $coluna = new ColunaRel();
    $coluna->titulo = 'ID';
    $coluna->nome = 'id_fechamento';
    ...
    $coluna = new ColunaRel();
    $coluna->titulo = 'Data Inicial';
    $coluna->nome = 'data_inicial';
    ...
    $coluna = new ColunaRel();
    $coluna->titulo = 'Data Final';
    $coluna->nome = 'data_final';
    $coluna->tipo = EnumTipoCampo::Data;
    $coluna->largura = 25;
    $coluna->alinhamento = EnumTipoAlinhamento::Esquerda;
    $relatorio->addColunaRel($coluna);
    ...
    $coluna->nome = 'tipo';
    $coluna->tipo = EnumTipoCampo::Select;
    $coluna->objeto = new EnumTipoFechamento();
    $coluna->largura = 30;
    $coluna->alinhamento = EnumTipoAlinhamento::Centralizado;
    $relatorio->addColunaRel($coluna);
    
    $coluna = new ColunaRel();
    $coluna->titulo = 'Observação';
    ...
    $comandoSQL =  "SELECT id_fechamento, data_inicial, data_final, turno, tipo, observacao ";
    $comandoSQL .= "  FROM fechamento";
    $comandoSQL .= " order by id_fechamento desc";
