...
if (!isset($dados['novasenha'])) {
    $erro = TRUE;
    $mensagem .= 'Campo: SENHA invalido! \n';
}


if (!isset($dados['confirmacao'])) {
    $erro = TRUE;
    $mensagem .= 'Campo: CONFIRMACAO invalido! \n';
}

if ($dados['novasenha'] <> $dados['confirmacao']) {
    $erro = TRUE;
    $mensagem .= 'Campo: SENHA E CONFIRMACAO nao confere! \n';
}
