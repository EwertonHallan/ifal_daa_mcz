...
require_once('../../classe/monitor.php');
	...
	if (count($resultado)) {
	    ...
	    foreach ($resultado as $res) {
	        ...
	        $msg .=' <td align="center"><input type=button id=bt_sel'.$res['id_monitor'].' name=bt_sel'.$res['id_monitor'].' value="Selecionar" onclick="selCampo(cadConta_Bancaria.id_monitor,cadConta_Bancaria.desc_id_monitor,\''.$res['id_monitor'].'\',\''.$res['nome'].'\');" /></td>';
	        $msg .='</tr>';
