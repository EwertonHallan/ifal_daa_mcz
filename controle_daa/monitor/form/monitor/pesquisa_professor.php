...
require_once('../../../freq_docentes/classe/professor.php');
	...
	if (count($resultado)) {
	    ...
	    foreach ($resultado as $res) {
	        ...
	        $msg .=' <td align="center"><input type=button id=bt_sel'.$res['id_professor'].' name=bt_sel'.$res['id_professor'].' value="Selecionar" onclick="selCampo(cadMonitor.id_professor,cadMonitor.desc_id_professor,\''.$res['id_professor'].'\',\''.$res['nome'].'\');" /></td>';
	        $msg .='</tr>';
