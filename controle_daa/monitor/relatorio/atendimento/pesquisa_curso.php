...
require_once('../../classe/curso.php');
	...
	if (count($resultado)) {
	    ...
	    foreach ($resultado as $res) {
	        ...
	        $msg .=' <td align="center"><input type=button id=bt_sel'.$res['id_curso'].' name=bt_sel'.$res['id_curso'].' value="Selecionar" onclick="selCampo(paramRel_frequencia.id_curso,paramRel_frequencia.desc_id_curso,\''.$res['id_curso'].'\',\''.$res['nome'].'\');" /></td>';
	        $msg .='</tr>';
