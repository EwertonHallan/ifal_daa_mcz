...
if (!$erro) {
    ...
    $relatorio->nome_relatorio = 'REL_BANCO';
    $relatorio->titulo_relatorio = 'RELAÇÃO DE BANCO';
    ...
    $comandoSQL =  "SELECT id_banco, nome, codigo ";
    $comandoSQL .= "  FROM banco";
