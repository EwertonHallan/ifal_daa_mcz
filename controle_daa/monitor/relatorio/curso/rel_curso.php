...
if (!$erro) {
    ...
    $relatorio->nome_relatorio = 'REL_CURSO';
    $relatorio->titulo_relatorio = 'RELAÇÃO DE CURSO';
    ...
    $coluna->objeto = new EnumTipoCurso();
    $coluna->largura = 70;
    $coluna->alinhamento = EnumTipoAlinhamento::Esquerda;
    $relatorio->addColunaRel($coluna);
    
    //Dados para o relatorio
    $comandoSQL =  "SELECT id_curso, nome, tipo ";
    $comandoSQL .= "  FROM curso";
